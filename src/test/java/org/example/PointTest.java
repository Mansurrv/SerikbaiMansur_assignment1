...
public class PointTest {
    ...
    private void runCorrectnessTest(int N, int numTrials) {
        ...
        for (int i = 0; i < numTrials; i++) {
            ...
            assertEquals(expected, actual, 1e-9,
                    "N=" + N + ", Trial #" + i + " not match. Output will be: " + expected + ", The real output: " + actual);
        }
    }
    ...
    void validateAgainstBruteForceMultipleTrialsN_100() {
        ...
        for (int i = 0; i < numTrials; i++) {
            ...
            assertEquals(expected, actual, 1e-9,
                    "O(n log n) not match with O(n^2) #" + i);
        }
    }
    @Test
    void testIdenticalPoints() {
        ...
        assertEquals(0.0, PairOfPoints.findClosestPair(points), 1e-9, "the distance between 22 points will be 0.");
    }
